        ...
        <div className="mt-6 bg-[var(--bg)] rounded-xl shadow-sm border border-[var(--border)] overflow-hidden">
          <div className="bg-black flex items-center justify-center p-4">
            {isCompleted ? (
              ...
              <div className="w-full h-64 flex items-center justify-center text-[var(--muted-fg)]">
          ...
          <div className="p-6 space-y-4">
            <h1 className="text-xl font-bold">{video.prompt}</h1>

            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-[var(--muted-fg)]">Model</span>
                <p className="font-mono text-[var(--fg)]">{video.model}</p>
              </div>
              <div>
                <span className="text-[var(--muted-fg)]">Created</span>
                <p className="text-[var(--fg)]">{video.created_at}</p>
              </div>
              <div>
                <span className="text-[var(--muted-fg)]">Status</span>
                <p className="text-[var(--fg)]">{video.status}</p>
              </div>
            </div>
